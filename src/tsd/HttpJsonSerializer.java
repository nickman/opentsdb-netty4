...
class HttpJsonSerializer extends HttpSerializer {
  ...
  public List<IncomingDataPoint> parsePutV1() {
    ...
    final ByteBuf buf = query.getContentBuffer();
    buf.markReaderIndex();
    final int firstbyte = buf.getInt(0);
    try {
      if (firstbyte == '{') {
        final IncomingDataPoint dp = 
          JSON.parseToObject(buf, IncomingDataPoint.class, query.getCharset());
        final ArrayList<IncomingDataPoint> dps = 
          new ArrayList<IncomingDataPoint>(1);
        dps.add(dp);
        return dps;
      } else {
        return JSON.parseToObject(buf, TR_INCOMING, query.getCharset());
      }
    } catch (IllegalArgumentException iae) {
    	buf.resetReaderIndex();
    	System.err.println(buf.toString(JSON.UTF8));
      throw new BadRequestException("Unable to parse the given JSON", iae);
    } finally {
    	try { buf.release(); } catch (Exception x) {/* No Op */}
    }
  }
  
  public static boolean isGzip(final ByteBuf buf) {
  ...
  public HashMap<String, String> parseSuggestV1() {
    ...
    if (json == null || json.isReadable(2)) {
      throw new BadRequestException(HttpResponseStatus.BAD_REQUEST,
          "Missing message content",
          "Supply valid JSON formatted data in the body of your request");
    }
    try {
      return JSON.parseToObject(query.getContentBuffer(), 
          new TypeReference<HashMap<String, String>>(){}, query.getCharset());
    } catch (IllegalArgumentException iae) {
      throw new BadRequestException("Unable to parse the given JSON", iae);
    }
  }
  ...
  public HashMap<String, List<String>> parseUidAssignV1() {
    ...
    try {
      return JSON.parseToObject(json, UID_ASSIGN, query.getCharset());
    } catch (IllegalArgumentException iae) {
      throw new BadRequestException("Unable to parse the given JSON", iae);
    }
  }
  ...
  public TSQuery parseQueryV1() {
    ...
    try {
      return JSON.parseToObject(json, TSQuery.class, query.getCharset());
    } catch (IllegalArgumentException iae) {
      throw new BadRequestException("Unable to parse the given JSON", iae);
    }
  }
  ...
  public LastPointQuery parseLastPointQueryV1() {
    ...
    try {
      return JSON.parseToObject(json, LastPointQuery.class, query.getCharset());
    } catch (IllegalArgumentException iae) {
      throw new BadRequestException("Unable to parse the given JSON", iae);
    }
  }
  ...
  public UIDMeta parseUidMetaV1() {
    ...
    try {
      return JSON.parseToObject(json, UIDMeta.class, query.getCharset());
    } catch (IllegalArgumentException iae) {
      throw new BadRequestException("Unable to parse the given JSON", iae);
    }
  }
  ...
  public TSMeta parseTSMetaV1() {
    ...
    try {
      return JSON.parseToObject(json, TSMeta.class, query.getCharset());
    } catch (IllegalArgumentException iae) {
      throw new BadRequestException("Unable to parse the given JSON", iae);
    }
  }
  ...
  public TreeRule parseTreeRuleV1() {
    ...
    return JSON.parseToObject(json, TreeRule.class, query.getCharset());
  }
  ...
  public List<TreeRule> parseTreeRulesV1() {
    ...
    return JSON.parseToObject(json, TR_TREE_RULES, query.getCharset());
  }
  ...
  public Map<String, Object> parseTreeTSUIDsListV1() {
    ...
    return JSON.parseToObject(json, TR_HASH_MAP_OBJ, query.getCharset());
  }
  ...
  public Annotation parseAnnotationV1() {
    ...
    return JSON.parseToObject(json, Annotation.class, query.getCharset());
  }
  ...
  public List<Annotation> parseAnnotationsV1() {
    ...
    return JSON.parseToObject(json, TR_ANNOTATIONS, query.getCharset());
  }
  ...
  public AnnotationBulkDelete parseAnnotationBulkDeleteV1() {
    ...
    return JSON.parseToObject(json, AnnotationBulkDelete.class, query.getCharset());
  }
  ...
  public SearchQuery parseSearchQueryV1() {
    ...
    return JSON.parseToObject(json, SearchQuery.class, query.getCharset());
  }
  ...
  public Deferred<ByteBuf> formatQueryAsyncV1(final TSQuery data_query, 
    ...
    final ByteBuf response = BufferManager.getInstance().ioBuffer(); 
  ...
  private ByteBuf serializeJSON(final Object obj) {  	
    if (query.hasQueryStringParam("jsonp")) {
    	return JSON.serializeToJSONPBytesBuf(query.getQueryStringParam("jsonp"), obj);
    } else {
    	return JSON.serializeToByteBuf(obj);
    }
  }
}
