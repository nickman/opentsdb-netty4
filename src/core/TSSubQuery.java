...
public final class TSSubQuery {
  ...
  public static void main(String[] args) {
  	TSSubQuery t = new TSSubQuery();
  	t.setMetric("foo.bar");
  	t.setAggregator("max");
  	t.setDownsample("2h-avg-nan");
  	t.setTags(Collections.singletonMap("dc", "dc1"));
  	t.setRate(false);
  	final RateOptions r = new RateOptions();
  	r.setCounterMax(102);
  	r.setDropResets(true);
  	r.setIsCounter(false);
  	r.setResetValue(5);
  	t.setRateOptions(r);
  	String s = JSON.serializeToString(t);
  	log(s);
  }
