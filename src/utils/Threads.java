...
//  }
  ...
  private static ThreadFactory timerThreadFactory(final String name) {
  	return new ThreadFactory() {  		
  		@Override
  		public Thread newThread(final Runnable r) {
  			final Thread t = new Thread(r, String.format("OpenTSDB Timer %s#%s", name, TIMER_ID.incrementAndGet()));
  			return t;
  		}
  	};
  }
...
//      }
//    }
    return new HashedWheelTimer(timerThreadFactory(name), 
